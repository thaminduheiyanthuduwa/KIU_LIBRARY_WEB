...
<section class="category-filter section-padding">
        ...
        <div class="center-content">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h2 class="section-title">Check Out The Databases Here</h2>
                    <span class="underline center"></span>
                </div>
            </div>
        </div>
        <div class="filter-buttons">
            <div class="filter btn" data-filter="all">Databases</div>
        </div>
    </div>
    <div id="category-filter">
        <ul class="category-list">
            ...
            <?php
            $select = $pdo->prepare("SELECT * FROM `kiu_edatabase` WHERE is_active = 1 and status = 'published'  order by id DESC");
            $select->execute();
            while ($row = $select->fetch(PDO::FETCH_ASSOC)) {
                ...
                <li class="category-item Nursing">
                    <figure>
                        <img style="height: 300px" src="images/database/<?php echo $row['cover_photo']; ?>"
                             alt="New Releaase"/>
                        <figcaption class="bg-orange">
                            <div class="info-block">
                                <h4><?php echo $row['title']; ?></h4>
                                <span class="author"><strong>Description:</strong> <?php echo $row['description']; ?></span>
                                <div class="rating">
                                    <span>☆</span>
                                    <span>☆</span>
                                    <span>☆</span>
                                ...
                                <a href="<?php echo $row['url']; ?>">Click Here<i

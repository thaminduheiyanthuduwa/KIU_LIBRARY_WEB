                            ...
                            <div class="flipcard">
                                <div class="front">
                                    ...
                                    <div class="bottom-info">
                                        ...
                                        <ul>
                                            <li>249/1, Malabe Road, Thalangama</li>
                                            <li>North, Koswatta,</li>
                                            <li>Battaramulla,Colombo</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="back">
                            ...
                            <div class="flipcard">
                                <div class="front">
                                    ...
                                    <div class="bottom-info">
                                        <span class="top-arrow"></span>
                                        <ul>
                                            <li><a href="tel:+123-456-7890">Local: +9411 2741878</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="back">
                                                ...
                                                <div class="contact-form bg-light margin-right">
                                                    ...
                                                    <div class="contact-fields">
                                                        <form id="contact" name="contact"
                                                              action="http://libraria.demo.presstigers.com/contact.php"
                                                              method="post">
                                                            <div class="row">
